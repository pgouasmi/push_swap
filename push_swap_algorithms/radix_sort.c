...
/*   Updated: 2023/04/03 17:39:39 by pgouasmi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lst_radix_sort(t_list **a_head, t_list **b_head)
{
	...
	Le compteur i permet de donner la place de temp (valeur que l'on teste)*/
		...
		/*Envoie le dernier element de B a sa tete puis PA*/
		if (count > 1)
		{
			temp = *b_head;
			while (temp)
...
/*ajouter compteur d'elem a envoyer dans b. si count == 1, alors ne pas l'envoyer*/